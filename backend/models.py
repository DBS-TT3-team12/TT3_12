...
class Post(db.Model):
    ...
    post_comment = db.relationship("POST_COMMENT", cascade='all, delete-orphan', backref = "post")
    liked_post = db.relationship("LIKED_POST", cascade='all, delete-orphan', backref = "post")
